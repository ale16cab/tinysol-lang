...
let%test "test_typecheck_mutability_10" = test_typecheck
  "contract C {
      function f(address payable a) public view { a.transfer(1); }
  }"
  false (* view functions cannot call transfer *)

let%test "test_typecheck_mutability_11" = test_typecheck
  "contract C {
      function g() public payable {}
      function f() public view { this.g{value: 1}(); }
  }"
  false (* view functions cannot call payable functions with non zero value *)
(*
